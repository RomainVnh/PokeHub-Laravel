    ...
    public function run(): void
    {
        $items = [
            ...
            [
                ...
                'category'    => 'title',
                'name'        => 'Rival Éternel',
                'description' => 'Pour ceux qui affrontent sans relâche leur destin.',
                'price'       => 2500,
                'preview'     => '',
                'sort_order'  => 8,
                'data'        => [
            ...
            [
                ...
                'description' => 'Domine le ciel comme un maître draconier.',
                'price'       => 6000,
                'preview'     => '',
                'sort_order'  => 9,
                'data'        => [
                    'gradient' => 'linear-gradient(135deg, #7c3aed, #2563eb, #06b6d4)',
                    'shadow'   => '0 2px 14px rgba(124,58,237,0.5)',
                ],
            ],
            [
                'slug'        => 'gardien-aura',
                ...
                'description' => 'Canalise l\'énergie mystique qui entoure toute chose.',
                'price'       => 4500,
                'preview'     => '',
                'sort_order'  => 10,
                'data'        => [
                    'gradient' => 'linear-gradient(135deg, #06b6d4, #8b5cf6, #ec4899)',
                    'shadow'   => '0 2px 12px rgba(139,92,246,0.45)',
                ],
            ],
            ...
            [
                ...
                'category'    => 'frame',
                'name'        => 'Cadre Flamme',
                'description' => 'Un cadre ardent qui brûle d\'intensité autour de ton avatar.',
                'price'       => 2000,
                'preview'     => '',
                'sort_order'  => 6,
                'data'        => [
                    'border' => '2px solid #ef4444',
                    'shadow' => '0 0 10px rgba(239,68,68,0.5), 0 0 20px rgba(249,115,22,0.25)',
                ],
            ],
            [
                'slug'        => 'cadre-ocean',
                'category'    => 'frame',
                'name'        => 'Cadre Océan',
                'description' => 'Les profondeurs marines entourent ton profil d\'un halo bleuté.',
                'price'       => 2000,
                'preview'     => '',
                'sort_order'  => 7,
                'data'        => [
                    'border' => '2px solid #3b82f6',
                    'shadow' => '0 0 10px rgba(59,130,246,0.5), 0 0 20px rgba(6,182,212,0.2)',
                ],
            ],
            [
                'slug'        => 'cadre-nature',
                ...
                'description' => 'Un cadre verdoyant inspiré de la forêt de Jade.',
                'price'       => 1800,
                'preview'     => '',
                'sort_order'  => 8,
                'data'        => [
                    'border' => '2px solid #22c55e',
                    'shadow' => '0 0 10px rgba(34,197,94,0.45), 0 0 18px rgba(16,185,129,0.2)',
                ],
            ],
            [
                'slug'        => 'cadre-electrik',
                'category'    => 'frame',
                'name'        => 'Cadre Électrik',
                'description' => 'Des éclairs crépitent autour de ton avatar.',
                'price'       => 2500,
                'preview'     => '',
                'sort_order'  => 9,
                'data'        => [
                    'border' => '2px solid #eab308',
                    'shadow' => '0 0 12px rgba(234,179,8,0.5), 0 0 24px rgba(250,204,21,0.25)',
                    'animation' => 'true',
                ],
            ],
            [
                ...
                'category'    => 'frame',
                'name'        => 'Cadre Ténèbres',
                'description' => 'Une aura sombre et menaçante enveloppe ton profil.',
                'price'       => 3500,
                'preview'     => '',
                'sort_order'  => 10,
                'data'        => [
                    'border' => '2px solid #7c3aed',
                    'shadow' => '0 0 14px rgba(124,58,237,0.5), 0 0 28px rgba(88,28,135,0.3)',
                    'animation' => 'true',
                ],
            ],
            ...
            [
                'slug'        => 'sleeve-dracaufeu',
                'category'    => 'sleeve',
                'name'        => 'Sleeve Dracaufeu',
                'description' => 'Un dos de carte enflammé inspiré du légendaire Dracaufeu.',
                'price'       => 3000,
                'preview'     => '',
                'sort_order'  => 6,
                'data'        => [
            ...
            [
                ...
                'category'    => 'sleeve',
                'name'        => 'Sleeve Mewtwo',
                'description' => 'L\'énergie psychique de Mewtwo se reflète sur ce dos de carte.',
                'price'       => 3500,
                'preview'     => '',
                'sort_order'  => 7,
                'data'        => [
                    'background' => 'linear-gradient(135deg, #4c1d95, #7c3aed, #a78bfa)',
                    'accent'     => 'linear-gradient(135deg, #c4b5fd, #e9d5ff)',
                    'color'      => '#8b5cf6',
                ],
            ],
            [
                ...
                'category'    => 'sleeve',
                'name'        => 'Sleeve Évoli',
                'description' => 'Un dos de carte chaleureux aux teintes d\'Évoli.',
                'price'       => 1500,
                'preview'     => '',
                'sort_order'  => 8,
                'data'        => [
            ...
            [
                'slug'        => 'sleeve-leviator',
                'category'    => 'sleeve',
                'name'        => 'Sleeve Léviator',
                'description' => 'La fureur des mers déchaînées sur tes cartes.',
                'price'       => 2500,
                'preview'     => '',
                'sort_order'  => 9,
                'data'        => [
                    'background' => 'linear-gradient(135deg, #0c4a6e, #0369a1, #0ea5e9)',
                    'accent'     => 'linear-gradient(135deg, #38bdf8, #7dd3fc)',
                    'color'      => '#0ea5e9',
                ],
            ],
            [
                'slug'        => 'sleeve-rayquaza',
                'category'    => 'sleeve',
                'name'        => 'Sleeve Rayquaza',
                'description' => 'Le seigneur du ciel orne le dos de tes cartes d\'émeraude.',
                'price'       => 5000,
                'preview'     => '',
                'sort_order'  => 10,
                'data'        => [
