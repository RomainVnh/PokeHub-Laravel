        ...
        <section class="relative overflow-hidden" style="height: 520px;">
            ...
            <div class="relative h-full flex flex-col items-center justify-center text-center px-8">
                ...
                <div class="relative w-full max-w-3xl mx-auto mb-8">
                    <svg class="absolute w-5 h-5 pointer-events-none" style="left: 20px; top: 50%; transform: translateY(-50%); color: var(--text-muted);" fill="currentColor" viewBox="0 0 512 512">
                    ...
                    <form action="{{ route('encyclopedia') }}" method="GET">
                        <input type="text" name="q" placeholder="Rechercher une édition, un Pokemon..."
                               class="input-dark w-full text-base" style="padding: 13px 24px 13px 52px; border-radius: 14px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12); backdrop-filter: blur(8px);" />
                    </form>
                </div>
